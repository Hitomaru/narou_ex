defmodule NarouEx.API.Queries do
  @moduledoc """
  ...
  ```
  iex> %NarouEx.API.Queries{}
  iex> |> NarouEx.API.Queries.encode_of([:t, :n])
  %NarouEx.API.Queries{
    gzip: 5,
    lim: 20,
    of: "t-n",
  ...
  def encode_of(queries, of_elements)
      when is_struct(queries, __MODULE__) and is_list(of_elements) do
    of_string =
      of_elements
  ...
  ```
  iex> queries = %NarouEx.API.Queries{}
  iex> queries |> NarouEx.API.Queries.encode_userid([1])
  %NarouEx.API.Queries{
    gzip: 5,
    lim: 20,
    of: nil,
  ...
  iex> queries |> NarouEx.API.Queries.encode_userid([1, 1000])
  %NarouEx.API.Queries{
    gzip: 5,
    lim: 20,
    of: nil,
